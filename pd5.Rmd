...
```
::: custom-text
¿Existe diferencia de percepciones sobre la calidad del servicio de la PNP en las distintas categorías de estratos y regiones en el 2023? 🤔
:::
...
## 3.¿Existe diferencia de medias en cuanto a la percepción de la calidad de la PNP entre estratos económicos?
...
ggplot(icmedia_estrato, aes(x = ESTRATO, y=Media)) +
  ...
  xlab("Estrato socioeconómico") + ylab("Promedio de percepción de la \n calidad de la PNP")+
  ylim(50, 53.5) 
```
