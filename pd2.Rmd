...
alta y baja. Asimismo la mediana más baja es la de la clase media. Por
otro lado vemos hay mucha dispersión dentro de la mayoría de categorías
menos en la de la clase alta. Esto quiere decir que la mayoría hubo
mayor homogeneidad en las respuesta del indicador. En otras palabras,
dentro de la clase alta, la mayoría percibe (50% entre Q1 y Q3) que
existe desigualdad en la calidad de vida entre 84 y 90 en una escala de
0 al 100; es decir, alta desigualdad. Los *outliers* se muestran como
