...
➡️ Análisis: Se puede notar que la mediana más alta es la de la clase
media baja. Asimismo la mediana más baja es la de clase baja. Por otro
lado vemos hay mucha dispersión dentro de la mayoría de categorías menos
en la de la clase alta. Esto quiere decir que la mayoría hubo mayor
homogeneidad en las respuesta del indicador. En otras palabras, dentro
de la clase alta, la mayoría percibe que existe desigualdad en la
calidad de vida entre 9 y 15 en una escala de 0 al 100; es decir, poca
desigualdad. Los *outliers* se muestran como puntos individuales más
allá del bigote de la caja, los puntos más alejados se encuentran en el
grupo de clase Baja.
...
(308) opina que hay mucha desigualdad económica en el país. Pero,
