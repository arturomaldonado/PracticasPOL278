...
💥 Otorguemosle etiquetas y categoricemosla como factor:
...
$((varSuma - minSuma)/(maxSuma-minSuma))*valorIndice$

**valorIndice**: *valor al que quiere que llegue el índice(si va del 0 al 10 será 10, del 0 al 50 será 50, etc).*
