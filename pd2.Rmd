...
comando mutate. Este comando forma parte del paquete dplyr. Lo usaremos
cada vez que se quiera modificar de alguna forma la data o alguna
...
comando summarise del paquete `dplyr`. Los resultados de la tabla deben
mantenerse, lo que varía debe ser la etiqueta de la categoría.
...
## 4.3 ¿Cuál es la diferencia de la percepción de desigualdad entre *clases*?
