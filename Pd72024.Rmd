...
El argumento de prop.table puede ser 1: *para calcular porcentaje por fil*, o 2: *para calcular por columna* ⚠️ Recuerda que es recomendable calcular los porcentajes sobre la variable sociodemográfica o aquella que antecede a la otra.
...
Otra forma de hacer ambas tablas de manera directa es mediante el comando **tbl_summary** del paquete **gtsummary**, dentro de este se debe indicar sobre qué variable calcular el 100%, para este ejercicio esa variable sería sexo
...
Esto quiere decir que el ser hombre o mujer sí se refleja en la percepción de la situación económica del país.
...
## 🔵¿Existe relación entre zona de vivienda y la percepción de la gestión de Boluarte?
