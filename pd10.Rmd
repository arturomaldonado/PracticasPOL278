...
$$
Y = 7.35 + \text{Edad} \times (-0.0053) + \text{Genero} \times (0.20) + \text{Primera línea} \times (-0.81) + \text{Trabaja desde casa} \times (0.19) + \text{Tiene niños en casa} \times (-0.47)
...
$$
Y = 7.27  + \text{Primera linea} \times (-0.88) +  \text{Tiene niños en casa} \times (-0.458)
