...
```{r}
ggplot(grafico2, aes(x=Alto_teleinfra, y= Porcentaje,fill=Region))+
...
Podemos afirmar que Europa cuenta unos niveles más altos de gobernanza digital en comparación a los otras regiones. Esto considerando que el 75% de sus datos superiores superan el 78.75. Las américas y Asia también muestran resultados elevados, aunque con mayor dispersión. Caso contrario al de África y Oceanía, en la que la mayoría de países no supera los 50 puntos.
...
El gráfico facilita la visualización de la dispersión de los datos. En el caso de Europa, se observa poca dispersión debido al pequeño tamaño de la caja, mientras que África presenta una mayor dispersión. Además, se identifican valores atípicos en las Américas, Europa y Oceanía. Estos valores corresponden a casos que se encuentran a más de 1.5 veces el rango intercuartílico (IQR) por encima o por debajo de los límites de la caja.
