...
AÑADIR BREVE DESCRIPCIÓN DE LA BD, explicar su composisción y link de informe final

EDITAR: Para ello, nos planteamos la siguiente pregunta de investigación, que nos guiará durante toda la sesión de hoy:
...
| ¿Cuál es la frecuencia de cada régimen en la muestra de países?
...
Adaptemos el diseño del gráfico :)
...
```{r}
data %>%
ggplot(aes(x=Puntaje)) + geom_histogram() +
geom_histogram(color = "black", fill ="blue") +
geom_text(stat = 'bin', aes(y = ..count.., label = ..count..), vjust = -0.5, size = 3, color = "black", bins = 30 , vjust = -10, size = 2, color = "black", bins = 30)+
