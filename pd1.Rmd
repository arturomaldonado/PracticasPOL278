...
Entonces, una vez configurados adecuadamente nuestros **objetos**, pidamos los estadísticos de tendencia central para nuestras variables de interés, esto es, el puntaje total (**Puntaje**)
...
ggplot(para_graficoPunt, aes(x=Puntaje)) + 
geom_histogram() 
```
...
```{r}
ggplot(para_graficoPunt, aes(x=Puntaje)) + 
geom_histogram(color = "black", fill ="blue") + geom_density(fill = "black", alpha = 0.25) + 
...
## Ejercicio: Escojan una variable numérica que no hayamos utilizado y hallen la mediana y la media de dicha variable, por continente.
